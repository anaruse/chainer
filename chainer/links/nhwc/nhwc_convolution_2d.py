from chainer.functions.nhwc import nhwc_convolution_2d
...
class NhwcConvolution2D(link.Link):
    ...
    def __init__(self, in_channels, out_channels, ksize=None, stride=1, pad=0,
        ...
        super(NhwcConvolution2D, self).__init__()
    ...
    def _initialize_params(self, in_channels):
        ...
        if self.w_layout == 'NCHW':
            ...
            W_shape = (self.out_channels, kh, kw, int(in_channels / self.groups))
    ...
    def forward(self, x):
        ...
        return nhwc_convolution_2d.nhwc_convolution_2d(
